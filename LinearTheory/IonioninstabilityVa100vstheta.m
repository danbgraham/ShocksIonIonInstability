...
disprelnominal = struct('ne',ne,'np',np,'na',na,'Te',Te,'Tp',Tp,'Ta',Ta,'Vab',Vab,'ld',ld,...
  'wpe',wpe,'wpp',wpp,'wpa',wpa,'kvec',kvec,'theta',theta,'wrmat',wrmat,'wimat',wimat);
save('disprelnominal.mat','disprelnominal');
...
title(h(1),'V_{\alpha} = 100 km s^{-1}','interpreter','tex','fontsize',14)
c = colorbar('peer',h(1));
...
title(h(2),'V_{\alpha} = 100 km s^{-1}','interpreter','tex','fontsize',14)
c = colorbar('peer',h(2));
